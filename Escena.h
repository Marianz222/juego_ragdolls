...
public:
	...
	virtual void actualizarElementosAlojados(int unidad_conversion, float potencia_disparo, int ragdolls_activos, int ragdolls_maximos, int puntaje, Vector2i posicion_cursor);
